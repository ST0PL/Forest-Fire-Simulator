...
// влажность по сезонам
  ...
  FIRE: {
    ...
    SUMMER_SPONTANEOUS_CHANCE: 0.01, // шанс случайного возгорания летом
    DEADTREE_MULTIPLIER: 2.0,
  },

  // параметры логики накопления стресса (только для старых деревьев)
  OLD_TREE: {
    STRESS_ACCUMULATION_RATE: 1.2, // базовая скорость накопления стресса за тик экстремальной жары
